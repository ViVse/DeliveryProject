        ...
        public async Task<ActionResult<string>> Create(CreateOrderRequest request)
        {
            ...
            try
            {
                ...
                command = new CreateOrderCommand()
                {
                    ...
                    Customer = new Customer() { Id = customer.Id, FullName = customer.FullName, Phone = customer.PhoneNumber },
                    DeliveryMan = new DeliveryMan() { Id = deliveryMan.Id, FullName = deliveryMan.FirstName + " " + deliveryMan.LastName, Phone = deliveryMan.Phone },
                    Products = products,
                    Address = new Address() { Id = address.Id, AddressLine = $"{address.City}, {address.AddressLine}" }
                };
